...
#### 模範解答の使い方
[[right | 模範解答には`ロック`がかかっていて編集できないようにしています。<br/> `コンポーネントリスト`というセクションがあるので、これを全て`自分のファイルにコピーしてからロックを外し確認`しましょう。<br/> **模範解答自体のロックは外さないでください。**]]
| ![模範解答のセクション](./img/answer.png)
[[right | ロックがかかったセクションは名前の部分をクリックするか、レイヤーパネルで選択することができます。]]
| ![模範解答のロック](./img/answer-2.png)

自分のファイルにコピーしたら、レイヤーパネルの鍵のマークをクリックしてロックを外して確認できます。

もし操作がわからない場合は Discord の[#質問場所](https://discord.com/channels/598545479860748288/1245591184848719924)で投稿してください！
